...
let brandNames = document.getElementById("brandKeys")
let models = document.getElementById("models")

let allBrands = Object.keys(mobiles)
for (let i = 0; i < allBrands.length; i++) {
    brandNames.innerHTML += `<option value='${allBrands[i]}'>${allBrands[i]}</option>`
}

function selectBrand() {
    let selectedBrand = brandNames.value
    let selectedModel = Object.keys(mobiles[selectedBrand])
